...
class ProjectSiteData:
    ...
    def __init__(self, title: str, role: str, headerCode: str, thumbType: str, galleryImages: list[str], links: list[Link], introParagraph: str, bodyContent: str):
        self.data: dict = {
            "title": title,
            "role": role,
    ...
    def __repr__(self):
        return "Project Site Data(" + self.data["title"] + ")"
...
testproject = ProjectSiteData(
    ...
    "Intro paragraph, where the world can be summarised over the course of an elevator trip. Oops, here's my floor",
