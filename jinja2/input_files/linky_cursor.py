...
project_data = ProjectSiteData(
    ...
    headerCode = r"""<style type="text/css">
                body {cursor: url("http://www.rw-designer.com/cursor-extern.php?id=193890"), auto;}
                a {cursor:url("http://www.rw-designer.com/cursor-extern.php?id=193891"), auto;}
                p, .h1, .role, .desc-title, .desc-date {cursor:url("http://www.rw-designer.com/cursor-extern.php?id=193892"), auto;}
                </style>""",
