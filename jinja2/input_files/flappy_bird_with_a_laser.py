...
project_data = ProjectSiteData(
    ...
    bodyContent = [
        ...
        BodyContent("Original Web Version", "November 14, 2023",
            ...
            r"""
            Flappy bird with a laser was originally conceived as a response to our "Modding Brief" at Falmouth University, but upon playing their Flappy Bird starter project (adding
            momentum when you jump, really?), I figured that the only thing to do was to recreate Flappy Bird in Unity from scratch :).
            """
        )
    ]
)
